...
@Service
public class InstanceToDataBaseService {
	...
	public void instantiateDevDatabase() throws ParseException {
		...
		Client client_1 = new Client(null, "Maria Silva", "send.development.mi@gmail.com", "12345678910",
				ClientTypeENUM.PESSOAFISICA);

		client_1.getPhones().addAll(Arrays.asList("27363323", "93838393"));

		AddressHouse address_1 = new AddressHouse(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", client_1,
				city_1);
		AddressHouse address_2 = new AddressHouse(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012",
				client_1, city_2);
		...
		Payment payment_2 = new PaymentForTicket(null, dateFormatter.parse("25/08/2018 00:00"), order_2,
				PaymentOptionENUM.PENDING, null);
